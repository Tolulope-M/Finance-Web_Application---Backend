...
private TransactionDao transactionDao;
    ...
    public NotificationResponse studentAppreciatedNotification(Long transactionId) {
        ...
        NotificationEntity notificationEntity = notificationDao.findNotificationEntityByTransaction(transaction);
        ...
        notification.setMessage(notificationEntity.getTeacher().getName()+" Appreciated you");
        notificationDao.saveRecord(notification);
